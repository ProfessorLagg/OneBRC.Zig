// based on https://github.com/clownpriest/xxhash/blob/master/src/xxhash.zig
...
inline fn uint64(buf: []const u8) u64 {
    return @as(u64, @intCast(buf[0])) |
        @as(u64, @intCast(buf[1])) << 8 |
        @as(u64, @intCast(buf[2])) << 16 |
        @as(u64, @intCast(buf[3])) << 24 |
        @as(u64, @intCast(buf[4])) << 32 |
        @as(u64, @intCast(buf[5])) << 40 |
        @as(u64, @intCast(buf[6])) << 48 |
        @as(u64, @intCast(buf[7])) << 56;
}
